...
const recentActivityUrl = (workspaceId: string) =>
  `/workspace/${workspaceId}/recent-activities`;
const pendingInvitationUrl = (workspaceId: string) =>
  `/workspace/${workspaceId}/members/pending-invitations`;
const activeSprintsUrl = (workspaceId: string) =>
  `/workspace/${workspaceId}/sprints`;
const jobQueueStatusUrl = (workspaceId: string) =>
  `/workspace/${workspaceId}/queues`;
